...
exports.default = new Interaction_1.default('close', async (client, button, config) => {
    ...
    return button.editReply({
        embeds: [new EmbedBuilder_1.default().default(button.member, config.buttons[button.customId].title, i18n_1.i18n.t(`messages.room_access_change_success.${state ? 'allow' : 'deny'}`, { voice_name: voice.toString() }))]
    });
});
