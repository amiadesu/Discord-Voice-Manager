...
exports.default = new Interaction_1.default('user', async (client, button, config) => {
    ...
    await button.editReply({
        embeds: [
            new EmbedBuilder_1.default().default(button.member, config.buttons[button.customId].title, i18n_1.i18n.t("messages.no_user_to_change_access_perms_specified", { voice_name: button.member.voice.channel.toString() }))
        ],
